...
modify_header_file(folder_lib+'/definitions.h', 'NTRHEADS', 62)         #number of threads
...
#Simulation setup
FinalTime = 0.30
DumpTime = 0.00000250  #for file printing
CFL = 0.1
Order = 7
...
for l in range(0,xcells): 
        for m in range(0,ycells): 
            for n in range(0,zcells):
                ...
                yaux=yc[l,m,n]-0.5
                zaux=zc[l,m,n]-0.5
                r=np.sqrt(xaux*xaux+yaux*yaux+zaux*zaux)
